...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  jailbreakMode: 'jailbreak.md',
  webServer: 'web-server.md',
  invariants: 'invariants.md',
  llm: 'llm-streaming.md',
  lsp: 'lsp.md',
  messageFeedback: 'feedback.md',
  modelBench: 'extensions.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  LlmModelCapabilities: 'llm-streaming.md',
  ...
  SessionId: 'core.md',
  SessionTerminalListRequest: 'terminal.md',
  SessionTerminalListValue: 'terminal.md',
  SessionTerminalOpenRequest: 'terminal.md',
  SessionTerminalOpenValue: 'terminal.md',
  SessionTerminalSendRequest: 'terminal.md',
  SessionTerminalSendValue: 'terminal.md',
  SessionTerminalReadRequest: 'terminal.md',
  SessionTerminalReadValue: 'terminal.md',
  SessionTerminalSignalRequest: 'terminal.md',
  SessionTerminalSignalValue: 'terminal.md',
  SessionTerminalCloseRequest: 'terminal.md',
  SessionTerminalCloseValue: 'terminal.md',
  ...
  ModelEnvironmentBackground: 'session.md',
  ModelEnvironmentCompaction: 'session.md',
  ModelEnvironmentOverrides: 'session.md',
  ModelEnvironmentPlan: 'session.md',
  ModelEnvironmentPolicy: 'session.md',
  ModelEnvironmentReason: 'session.md',
  SessionOpenWorkspacePathRequest: 'session.md',
  SessionOpenWorkspacePathValue: 'session.md',
  SessionModelEnvironmentRequest: 'session.md',
  SessionModelEnvironmentValue: 'session.md',
  ...
  SessionSelectModelRolesRequest: 'session.md',
  SessionSelectModelRolesValue: 'session.md',
  PromptEnhancementRequest: 'session.md',
  PromptEnhancementValue: 'session.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ProjectRecord: 'collaboration project record is owned by packages/web/collab-studio/src/types.ts',
  RoundRecord: 'benchmark round record is owned by packages/web/model-bench/src/types.ts',
