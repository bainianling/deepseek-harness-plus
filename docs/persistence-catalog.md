...
<a id="dual-modelplan-skipped--log-only"></a>

#### `dual-model/plan-skipped` — log-only
...
Source: [`packages/api/session-controller/src/types.ts:58`](../packages/api/session-controller/src/types.ts)
...
<a id="game-swapstate--log-only"></a>

#### `game-swap/state` — log-only
...
Source: [`packages/core/session/src/historical-events.ts:30`](../packages/core/session/src/historical-events.ts)
...
Source: [`packages/core/session/src/historical-events.ts:57`](../packages/core/session/src/historical-events.ts)
...
Source: [`packages/core/session/src/historical-events.ts:45`](../packages/core/session/src/historical-events.ts)
...
Source: [`packages/core/session/src/historical-events.ts:38`](../packages/core/session/src/historical-events.ts)
...
Source: [`packages/api/session-controller/src/types.ts:50`](../packages/api/session-controller/src/types.ts)

<a id="modelroles--log-only"></a>

#### `model/roles` — log-only
...
Source: [`packages/api/session-controller/src/types.ts:52`](../packages/api/session-controller/src/types.ts)
...
Source: [`packages/schedule/schedule/src/types.ts:227`](../packages/schedule/schedule/src/types.ts)
