...
Source: [`packages/web/ai-news/src/types.ts:66`](../packages/web/ai-news/src/types.ts)
...
Requires: `agentDefaultModel` · `agents` · `attachments` · `fileUploads` · `llm` · `sessions` · `sessionProjections` · `sessionQuery` · `terminals` · `typert` · `workspaceRegistry`
...
Source: [`packages/api/session-controller/src/index.ts:97`](../packages/api/session-controller/src/index.ts)
...
Source: [`packages/web/collab-studio/src/types.ts:186`](../packages/web/collab-studio/src/types.ts)

<a id="deepseek-aidsh-compaction-basic"></a>

## `@deepseek-ai/dsh-compaction-basic`

Requires: `llm` · `tokenMeter` · `sessions` · `settings`
...
Source: [`packages/jailbreak/jailbreak-mode/src/index.ts:73`](../packages/jailbreak/jailbreak-mode/src/index.ts)
...
Source: [`packages/web/model-bench/src/types.ts:210`](../packages/web/model-bench/src/types.ts)
