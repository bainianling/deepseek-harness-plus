...
<a id="llmresponse-closed--log-only"></a>

#### `llm/response-closed` — log-only
...
<a id="llmresponse-item--log-only"></a>

#### `llm/response-item` — log-only
...
<a id="llmresponse-opened--log-only"></a>

#### `llm/response-opened` — log-only
...
<a id="modelenvironment--log-only"></a>

#### `model/environment` — log-only
...
来源：[`packages/api/session-controller/src/types.ts:47`](../packages/api/session-controller/src/types.ts)
