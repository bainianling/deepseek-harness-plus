...
Types: [SessionId](core.md) · [SessionInspection](persistence.md) · [SessionSearchRequest](session-query.md) · [SessionTerminalCloseRequest](terminal.md) · [SessionTerminalCloseValue](terminal.md) · [SessionTerminalListRequest](terminal.md) · [SessionTerminalListValue](terminal.md) · [SessionTerminalOpenRequest](terminal.md) · [SessionTerminalOpenValue](terminal.md) · [SessionTerminalReadRequest](terminal.md) · [SessionTerminalReadValue](terminal.md) · [SessionTerminalSendRequest](terminal.md) · [SessionTerminalSendValue](terminal.md) · [SessionTerminalSignalRequest](terminal.md) · [SessionTerminalSignalValue](terminal.md)
