 ...
 */
@Remote('selectModelRoles') selectModelRoles(request: SessionSelectModelRolesRequest): Promise<SessionSelectModelRolesValue>
 ...
 */
@Remote('enhancePrompt') async enhancePrompt( request: PromptEnhancementRequest, signal: AbortSignal, ): Promise<PromptEnhancementValue>
