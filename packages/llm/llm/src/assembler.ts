...
export class BlockAssembler {
  ...
  private _responseReplay: LlmResponseLifecycle | undefined
  ...
  push(chunk: StreamChunk): void {
    switch (chunk.type) {
      ...
      case 'finish': {
        ...
        this._responseReplay = chunk.responseReplay
        return
      }
  ...
  /** Provider-neutral response lifecycle from the terminal finish chunk. */
  get responseReplay(): LlmResponseLifecycle | undefined {
    return this._responseReplay
  }
