...
export interface WireRequest {
  ...
  temperature?: number
  /**
   * Repetition penalty sampled by the provider (adapter-level deployment
   * default, never a per-request control). Omission keeps the provider
   * default of 1 (no penalty).
   */
