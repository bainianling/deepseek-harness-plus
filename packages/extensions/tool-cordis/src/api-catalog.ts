...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'LlmResponseClosed',
    declaration: 'export interface LlmResponseClosed {\n    readonly route: LlmResponseRoute;\n    readonly responseId?: ProviderResponseId;\n    readonly status: LlmResponseTerminalStatus;\n    readonly failure?: LlmFailure;\n}',
  },
  {
    name: 'LlmResponseItem',
    declaration: 'export interface LlmResponseItem {\n    readonly route: LlmResponseRoute;\n    readonly responseId?: ProviderResponseId;\n    readonly itemIndex: number;\n    readonly kind: LlmResponseItemKind;\n    readonly payload: JsonValue;\n}',
  },
  {
    name: 'LlmResponseItemKind',
    declaration: 'export type LlmResponseItemKind = \'message\' | \'reasoning\' | \'tool-call\' | \'tool-result\';',
  },
  {
    name: 'LlmResponseLifecycle',
    declaration: 'export interface LlmResponseLifecycle {\n    readonly opened: LlmResponseOpened;\n    readonly items: readonly LlmResponseItem[];\n    readonly closed: LlmResponseClosed;\n}',
  },
  {
    name: 'LlmResponseOpened',
    declaration: 'export interface LlmResponseOpened {\n    readonly route: LlmResponseRoute;\n    readonly responseId?: ProviderResponseId;\n    readonly state: LlmModelState;\n}',
  },
  {
    name: 'LlmResponseRoute',
    declaration: 'export interface LlmResponseRoute {\n    readonly provider: string;\n    readonly model: string;\n}',
  },
  {
    name: 'LlmResponseTerminalStatus',
    declaration: 'export type LlmResponseTerminalStatus = \'completed\' | \'incomplete\' | \'failed\' | \'cancelled\';',
  },
  {
    name: 'LlmRuntime',
  ...
  },
  {
    ...
    declaration: 'export type ProviderResponseId = Branded<\'ProviderResponseId\'>;',
  },
  {
    name: 'PrunedEntry',
