...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'ClientFailure',
    declaration: 'export type ClientFailure = RemoteFailure | SessionError;',
  },
  {
    name: 'ClientRemote',
  ...
  {
    name: 'ClientResult',
    declaration: 'export type ClientResult<T> = {\n    readonly ok: true;\n    readonly value: T;\n} | {\n    readonly ok: false;\n    readonly error: ClientFailure;\n};',
  },
  {
    name: 'CommonKeyOf',
