...
Reasoning rows preserve their durable block unchanged while omitting provider control delimiters such as `<thinking>` and `<analysis>` from both streaming and settled presentation.
