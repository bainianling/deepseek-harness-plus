...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface GlobalStandardProps {
    /**
     * Live value of one address, resolved through the provider registered for
     * its protocol. Optional because the local v3 client layer mounts no
     * resource consumer; components that use it receive it from the runtime.
     */
