...
export const zh = {
  ...
  'menu.fork': '分叉会话',
  'menu.moveSession': '移动到工作区…',
  'menu.archiveSession': '归档会话',
  'menu.deleteSession': '删除对话',
  'move.session.title': '移动对话到工作区',
  'move.session.desc': '选择“{name}”要移动到的工作区：',
  'move.session.current': '当前所在',
  'move.session.pending': '正在移动…',
  'delete.session.title': '删除对话',
  'delete.session.desc': '将永久删除对话“{name}”及其全部记录，此操作无法撤销。',
  'delete.session.pending': '正在删除对话…',
...
export const en = {
  ...
  'menu.moveSession': 'Move to workspace…',
  'menu.archiveSession': 'Archive session',
  'menu.deleteSession': 'Delete conversation',
  'move.session.title': 'Move conversation to workspace',
  'move.session.desc': 'Pick the workspace to move “{name}” into:',
  'move.session.current': 'current',
  'move.session.pending': 'Moving…',
  'delete.session.title': 'Delete conversation',
  'delete.session.desc': 'This permanently deletes the conversation “{name}” and its entire log. This cannot be undone.',
  'delete.session.pending': 'Deleting conversation…',
