...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /** Optional dual-model thinking/execution control immediately after attachments. */
    'conversation.input.modelRoles': { kind: 'single'; scope: 'session'; owner: InputControlOwnerProps }
    ...
    /** Jailbreak-mode status chip inside the composer tool row. */
...
export type ComposerBarProps =
  ...
  & PropsRenderSlots<
    ...
    | 'conversation.input.left' | 'conversation.input.modelRoles'
