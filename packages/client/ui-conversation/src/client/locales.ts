...
export const zh = {
  ...
  'image.pending': '待发送图片',
  'image.import': '导入图片',
  'image.added': '已添加 {count} 个附件',
  'attachment.import': '导入文件或图片',
  'attachment.dropTitle': '拖到此处即可添加文件或图片',
  'attachment.dropDesc': '图片发送给模型，其他文件保存到工作区供智能体读取',
  'attachment.dropBlocked': '当前无法添加附件',
  'file.pending': '待发送文件',
  'file.remove': '移除文件 {name}',
  'file.tooMany': '一条消息最多添加 {count} 个文件',
  'file.fileTooLarge': '单个文件不能超过 {size}',
  'file.totalTooLarge': '文件总大小超过 {size}，请移除部分文件',
  'file.importFailed': '文件保存失败（{reason}），请重试',
  'file.subagentUnsupported': '子智能体会话暂不支持文件',
  ...
  'command.filesUnsupported': '/{command} 不接受文件附件，请先移除文件',
  'ask.rowTitle': '提问',
  'ask.waiting': '等待回答',
  'ask.cancelled': '已取消',
...
export const en = {
  ...
  'image.import': 'Add image',
  'image.added': '{count} attachment(s) added',
  'attachment.import': 'Add files or images',
  'attachment.dropTitle': 'Drop files or images here to add them',
  'attachment.dropDesc': 'Images go to the model; other files are saved to the workspace for the agent',
  'attachment.dropBlocked': 'Attachments cannot be added right now',
  'file.pending': 'Pending file',
  'file.remove': 'Remove file {name}',
  'file.tooMany': 'A message can include up to {count} files',
  'file.fileTooLarge': 'Each file must be smaller than {size}',
  'file.totalTooLarge': 'Files exceed {size} in total; remove some and try again',
  'file.importFailed': 'Saving the file failed ({reason}); try again',
  'file.subagentUnsupported': 'Subagent sessions do not support files yet',
  ...
  'command.filesUnsupported': '/{command} does not accept file attachments; remove them first',
