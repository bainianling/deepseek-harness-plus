...
None, as the controller records model-environment metadata while the Agent and LLM packages own prompt assembly and tool schemas.

#### KV Cache effect

None; this package does not change the assembled request or provider cache inputs.
