...
flowchart LR
  ...
  plugin_dsh_base_terminal_shell["terminal-shell<br/>@deepseek-ai/dsh-terminal-bash"]
  cfg --> plugin_dsh_base_terminal_shell
...
| `terminal-shell` | `@deepseek-ai/dsh-terminal-bash` |
